...
$sql = "SELECT p.id, p.img_md as thumb, p.name as p_name, c.name as c_name, p.price FROM products as p LEFT JOIN categories as c ON p.category_id = c.id ORDER BY p.created_at DESC";
                  ...
                  <div class="card text-center card-product">
                    <div class="card-product__img">
                      ...
                      <ul class="card-product__imgOverlay">
                        ...
                        <li><button id="basket"><i class="ti-heart"></i></button></li> -->
                      </ul>
                    </div>
                    <div class="card-body">
                      <p><?=$product['c_name']?></p>
